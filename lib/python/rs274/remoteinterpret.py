...
class StatMixin:
    def __init__(self, s, r):
        self.s = s
        self.tools = list(s.io.tool_table)
        self.random = r
    ...
    def get_external_angular_units(self):
        return self.s.config.angular_units or 1.0

    def get_external_length_units(self):
        return self.s.config.linear_units or 1.0

    def get_axis_mask(self):
        return self.s.config.axis_mask

    def get_block_delete(self):
        return self.s.motion.block_delete
