...
typedef struct {
    ...
    __s32           old_raw_count;    /* used by update to detect movement */
    __s32           raw_count;
    __u32           timestamp;
    __s32           index_count;
    ...
    hal_float_t     *phase_error_count;
    double          old_scale;
    double          scale;          /* reciprocal value used for scaling */
    hal_float_t     *vel;

    hal_u32_t       *counter_period;
    hal_u32_t       *counter_overflow_count;
    hal_u32_t       *counter_dir_change_count;
    hal_float_t     *counter_vel;
    hal_u32_t       *capture_pre;   /* capture timer prescaler */
    hal_u32_t       old_capture_pre;
    hal_float_t     capture_tick;
